...
<head>
    <meta charset="UTF-8">
    <title>Manage Classrooms | Audisankara University</title>
...
<body class="bg-slate-50 text-slate-800 flex h-screen overflow-hidden">
    ...
    <aside class="w-72 bg-slate-900 text-white flex flex-col shadow-2xl z-20">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
            ...
            <a href="manage_classrooms.php" class="flex items-center gap-3 px-4 py-3 bg-indigo-600/10 text-indigo-400 rounded-xl transition-all duration-200 border border-indigo-500/20 shadow-sm">
